...
export function SyncDiagram({ className }: { className?: string }) {
	...
	return (
		...
		>
			<defs>
				<linearGradient id={gid} x1="0" y1="0" x2="720" y2="0" gradientUnits="userSpaceOnUse">
			...
			/>
			<rect x="16" y="40" width="240" height="200" rx="14" stroke={`url(#${gid})`} strokeWidth="1" opacity="0.25" />
			<text x="136" y="72" textAnchor="middle" fill="oklch(0.97 0.002 264)" fontFamily="monospace" fontSize="13" fontWeight="600">
				Your machine
			</text>
			<text x="136" y="90" textAnchor="middle" fill="oklch(0.64 0.01 264)" fontFamily="monospace" fontSize="10">
				local-first · $0
			</text>
			...
			<rect
				...
				fill="oklch(0.16 0.008 264 / 0.6)"
			/>
			<rect x="464" y="40" width="240" height="200" rx="14" stroke={`url(#${gid})`} strokeWidth="1" opacity="0.25" />
			<text x="584" y="72" textAnchor="middle" fill="oklch(0.97 0.002 264)" fontFamily="monospace" fontSize="13" fontWeight="600">
				TekMemo Cloud
			</text>
			<text x="584" y="90" textAnchor="middle" fill="oklch(0.64 0.01 264)" fontFamily="monospace" fontSize="10">
				file replica · dumb
			</text>
			...
			<Blob x={576} y={166} />
			<Blob x={632} y={166} />
			<text x="584" y="212" textAnchor="middle" fill="oklch(0.64 0.01 264)" fontFamily="monospace" fontSize="10">
			...
			<path d="M 266 140 L 274 135 L 274 145 Z" fill="oklch(0.62 0.17 248)" opacity="0.5" />
			<text x="360" y="128" textAnchor="middle" fill="oklch(0.82 0.08 248)" fontFamily="monospace" fontSize="11" fontWeight="600">
				push / pull
			</text>
			<text x="360" y="158" textAnchor="middle" fill="oklch(0.64 0.01 264)" fontFamily="monospace" fontSize="10">
	...
	return (
		<g>
			<rect
				...
				height="40"
				rx="8"
				stroke={highlight ? "oklch(0.62 0.17 248 / 0.5)" : "oklch(1 0 0 / 0.10)"}
				strokeWidth="1"
...
function Blob({ x, y }: { x: number; y: number }) {
	return (
		<g>
			...
			/>
			<rect x={x + 8} y={y + 8} width="20" height="3" rx="1.5" fill="oklch(0.62 0.17 248 / 0.5)" />
			<rect x={x + 8} y={y + 15} width="14" height="3" rx="1.5" fill="oklch(1 0 0 / 0.12)" />
		</g>
	);
}
