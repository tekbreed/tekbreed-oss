...
| **Cloud client** | The `@tekbreed/tekmemo-cloud-client` package, handling API transport and auth. |
...
| **MCP** | Model Context Protocol. An open standard used by `@tekbreed/tekmemo-mcp-server` to expose memory to IDEs and agents. |
