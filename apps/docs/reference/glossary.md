...
| **Cloud client** | The `@tekmemo/cloud-client` package, handling API transport and auth. |
...
| **MCP** | Model Context Protocol. An open standard used by `@tekmemo/mcp-server` to expose memory to IDEs and agents. |
