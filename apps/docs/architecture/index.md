...
2. **Local filesystem** — File-backed storage adapter (`@tekbreed/tekmemo-fs`)
3. **Recall and providers** — Embedding, vector search, and reranking adapters
4. **Graph memory** — Entities and relationships (`@tekbreed/tekmemo-graph`)
5. **Cloud client** — TekMemo Cloud API transport (`@tekbreed/tekmemo-cloud-client`)
