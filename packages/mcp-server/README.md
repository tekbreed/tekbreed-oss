...
```bash
pnpm --filter @tekmemo/mcp-server typecheck
pnpm --filter @tekmemo/mcp-server test:run
pnpm --filter @tekmemo/mcp-server build
pnpm --filter @tekmemo/mcp-server lint:package
```
...
- npm package: `@tekmemo/mcp-server`
