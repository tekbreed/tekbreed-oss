...
import { matchesMetadataFilter } from "../filters/metadata-filter.js";
import type {
	GraphDecayInput,
	GraphDirection,
	GraphEdge,
...
import { cloneJson, uniqueStrings } from "../utils/clone.js";
import { stableEdgeId } from "../utils/ids.js";
import { mergeMetadata } from "../utils/metadata.js";
import { mergeSourceRefs } from "../utils/source-refs.js";
import { isExpired, isInactive, nowIso } from "../utils/time.js";
import {
	edgeIdentitySalt,
	normalizeEdge,
